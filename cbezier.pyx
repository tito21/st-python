...
cdef cnp.ndarray reparameterize(cnp.ndarray bezier, cnp.ndarray points, cnp.ndarray u):
...
cdef cnp.ndarray newton_raphson_root_find(cnp.ndarray bezier, cnp.ndarray point, double u):

    Q_u = bezier_point_c(3, bezier, u)

    Q1 = 3.0 * (bezier[1:] - bezier[:-1])
    Q2 = 2.0 * (bezier[1:] - bezier[:-1])

    Q1_u = bezier_point_c(2, Q1, u)
    Q2_u = bezier_point_c(1, Q2, u)
...
cdef cnp.ndarray compute_max_error(cnp.ndarray bezier, cnp.ndarray points, cnp.ndarray u):

    p = bezier_point_c(3, bezier, u)
...
cdef generate_bezier(cnp.ndarray points, cnp.ndarray u, cnp.ndarray t_hat1, cnp.ndarray t_hat2):
...
cdef cnp.ndarray chord_length_parametrization(cnp.ndarray points):
...
cdef cnp.ndarray bezier_point_c(int degree, cnp.ndarray bezier, cnp.ndarray t):
